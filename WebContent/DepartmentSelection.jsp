...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
	...
	<%
         User currentUser = (User)request.getAttribute("user"); String name=currentUser.getName(); 
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="/CentralizedOnlineReservationSystem/UserManageReservation?username=<%=username%>">Manage My Reservarion</a></li>
          </ul>
        </div><!-- /.nav-collapse -->
      </div><!-- /.container -->
    </nav><!-- /.navbar -->
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="row">
			...
			String img = temp.getImg();%>
			<div class="col-xs-6 col-lg-4">
				<h2><%=departmentName %></h2>
				<img style="width : 200px; height : 200px;" src="<%=img %>" ></img>
				<p><a class="btn btn-default" href="/CentralizedOnlineReservationSystem/ListFacilities?departmentName=<%=departmentName %>&username=<%=username%>" role="button">View details &raquo;</a></p>
