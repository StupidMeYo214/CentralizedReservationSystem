...
/**
 * Servlet implementation class DptAdminGetReservations
 */
@WebServlet("/DptAdminGetReservations")
public class DptAdminReservationController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DptAdminReservationController() {
        super();
